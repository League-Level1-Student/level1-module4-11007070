...
public class Jeopardy implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (buttonPressed.equals(firstButton)) {
			askQuestion("Which planet is closest to the sun?", "Mercury", 200);
		}
		...
		// If the buttonPressed was the secondButton
			...
			askQuestion("Who was the first person on the Moon?", "Neil Armstrong", 400);
		}
		
		else if (buttonPressed.equals(thirdButton)) {
			askQuestion("True or False: Does oxygen take up most of Earth's atomsphere?", "false", 600);
		}
		
		else if (buttonPressed.equals(fourthButton)) {
			askQuestion("What does NASA stand for?", "National Aeronautics and Space Administration", 800);
		}
